...
public class LookedActivity extends AppCompatActivity {
    ...
    private LookedFragment.OnFragmentInteractionListener mListener;
    ...
    private class LoadLookTask extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String ... params){
            try {
                ...
                String sql = "SELECT video.id, video.img_url, video.name, looked.id, video.rating_value FROM video,looked WHERE looked.user_id="+userID+" and video.id=looked.film_id";
    ...
    private void displayMyView(LinearLayout liner,ArrayList<String> array,int numbers,ArrayList<String> urls,ArrayList<Integer> ids,ArrayList<Integer> lds,ArrayList<Float> FR){
        for(int i=0;i<numbers;i++) {
            ...
            final View view = getLayoutInflater().inflate(R.layout.looked_list, null);
            ...
            remove.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(LookedActivity.this, "Видалено", Toast.LENGTH_SHORT).show();
                }
            });
            ...
            tv4.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(LookedActivity.this, VideoActivity.class);
    ...
    private class DelTask extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String ... params){
            try {
                ...
                String sql = "DELETE FROM looked WHERE id="+z;
                st.execute(sql);
